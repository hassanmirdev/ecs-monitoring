...
| <a name="input_availability_zones"></a> [availability\_zones](#input\_availability\_zones) | AWS availability zones | `list(string)` | <pre>[<br/>  "us-east-1a",<br/>  "us-east-1b"<br/>]</pre> | no |
...
| <a name="input_image_url"></a> [image\_url](#input\_image\_url) | Appointment Container Image URL | `string` | `"677276078111.dkr.ecr.us-east-1.amazonaws.com/my-app-repo:appointment-service-latest"` | no |
| <a name="input_image_url_patient"></a> [image\_url\_patient](#input\_image\_url\_patient) | Container Image URL | `string` | `"677276078111.dkr.ecr.us-east-1.amazonaws.com/my-app-repo:patient-service-latest"` | no |
